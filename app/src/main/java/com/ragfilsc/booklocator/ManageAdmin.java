...
public class ManageAdmin extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle((Html.fromHtml("<font color=\"#FFFFFF\">" + "Manage Admin")));
        ...
        public void run() {
            ...
            runOnUiThread(new Runnable(){
                ...
                public void run() {
                    ...
                    ConnectivityManager cManager = (ConnectivityManager) getSystemService(ManageAdmin.this.CONNECTIVITY_SERVICE);
                    ...
                    if (nInfo != null && nInfo.isConnected())
                    {
                        ...
                        {
                            ipAddress =  getString(R.string.dbserver).toString() + getString(R.string.adminsearchadmin).toString() + "?search_string=" + search_string;
                        }
                        else if (DeleteFlag==true)
                        {
                            ipAddress =  getString(R.string.dbserver).toString() + getString(R.string.admindeleteadmin).toString() + "?search_string=" + SelectedIndex;
                        }
                        else
                        {
                            ipAddress =  getString(R.string.dbserver).toString() + getString(R.string.adminviewadmin).toString() ;
                        }
...

                    {
                        ...
                        Toast.makeText(ManageAdmin.this, "Connect to Wi-Fi Internet network or turn on Mobile Data.", Toast.LENGTH_SHORT).show();
                        start = false;
                    }
                }});
        }
    ...
    private void ChoppingData(String json) throws JSONException {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(ManageAdmin.this, android.R.layout.simple_spinner_item, dbRecords);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_manage_admin, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.Edit:
                ...
                {
                    Intent intent = new Intent(ManageAdmin.this, EditAdmin.class);
                    intent.putExtra("AdminId", SelectedIndex.toString());
