...
public class ManageBook extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle((Html.fromHtml("<font color=\"#FFFFFF\">" + "Manage Book")));
        ...
        public void run() {
            ...
            runOnUiThread(new Runnable(){
                ...
                public void run() {
                    ...
                    ConnectivityManager cManager = (ConnectivityManager) getSystemService(ManageBook.this.CONNECTIVITY_SERVICE);
                    ...
                    if (nInfo != null && nInfo.isConnected())
                    {
                        ...
                        {
                            ipAddress =  getString(R.string.dbserver).toString() + getString(R.string.admindeletebook).toString() + "?search_string=" + SelectedIndex;
                        }
                        else
                        {
...

                    {
                        ...
                        Toast.makeText(ManageBook.this, "Connect to Wi-Fi Internet network or turn on Mobile Data.", Toast.LENGTH_SHORT).show();
                        start = false;
                    }
                }});
        }
    ...
    private void ChoppingData(String json) throws JSONException {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(ManageBook.this, android.R.layout.simple_spinner_item, dbRecords);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_manage_book, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.Edit:
                ...
                {
                    Intent intent = new Intent(ManageBook.this, EditBook.class);
